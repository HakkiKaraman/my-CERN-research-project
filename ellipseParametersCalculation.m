...
Ellipse.xCoordinateMajorAxisEndPoints = [(Ellipse.xCoordinateCenter - Ellipse.lengthSemiMajorAxis*cos(theta)) (Ellipse.xCoordinateCenter + Ellipse.lengthSemiMajorAxis*cos(theta))];
Ellipse.yCoordinateMajorAxisEndPoints = [(Ellipse.yCoordinateCenter - Ellipse.lengthSemiMajorAxis*sin(theta)) (Ellipse.yCoordinateCenter + Ellipse.lengthSemiMajorAxis*sin(theta))];
Ellipse.xCoordinateMinorAxisEndPoints = [(Ellipse.xCoordinateCenter + Ellipse.lengthSemiMinorAxis*sin(theta)) (Ellipse.xCoordinateCenter - Ellipse.lengthSemiMinorAxis*sin(theta))];
Ellipse.yCoordinateMinorAxisEndPoints = [(Ellipse.yCoordinateCenter - Ellipse.lengthSemiMinorAxis*cos(theta)) (Ellipse.yCoordinateCenter + Ellipse.lengthSemiMinorAxis*cos(theta))];
